...
Time_Input = ST_Form_2.slider("Entry & Exit Time Inputs", min_value = time(9, 15), max_value = time(15, 30), value = (time(9, 30), time(15, 15)), step = timedelta(minutes = 15))
...
Sell_Dist = ST_Form_2.slider("Sell Distance", min_value = -15, max_value = 40, value = (0, 2))
